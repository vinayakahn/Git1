...
<body onload="backToLogin()">
	...
	<% String value = request.getParameter("facility");
		...
		<h3 style="color:brown; text-align:center;"> 7th day life Babies </h3>
		<%
			...
			{				
				...
				System.out.println("kmcPeriod in 7thday life = "+kmcPeriod);
				System.out.println("facility in 7thday life = "+value);
				...
				<div class="container">				
				<div class="row">				
				  <div id="7th day life babies" class="exporttable table-responsive2">				  
