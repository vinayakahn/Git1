		     ...
		     <div class="exporttable table-responsive2">
                    ...
                    <table class="table table-bordered table-striped tableheader">
                      <thead>
						...
						<th style="width:100px;word-wrap:break-word;"> Baby DOB </th>							
						<th style="width:80px;word-wrap:break-word;"> Patient ID1 </th>
						<th style="width:100px;word-wrap:break-word;"> Mother Name </th>
						<th style="width:100px;word-wrap:break-word;"> Husband Name </th>
						<th style="width:80px;word-wrap:break-word;"> Time of Birth </th>
						<th style="width:80px;word-wrap:break-word;"> Baby Birth Weight </th>
						<th style="width:80px"> Baby Sex </th>
						<th style="width:100px"> Phone1 </th>
						<th style=";word-wrap:break-word;"> Thayi Card No </th>
					</tr>				
                      </thead>
                    </table>
                    <div class="tablebody">
						...
						if(returnAck>1){
							 ...
							 <% }
							  %>
							    ...
							    <td style="width:200px;word-wrap:break-word;"> <%= id%> </td>    	
								<td style="width:80px;word-wrap:break-word;"><%= bd.facility%></td> 	
								<td style="width:100px;word-wrap:break-word;"><%= bd.dob%></td>						
								<td style="width:80px;word-wrap:break-word;"> <%= bd.pid1%> </td>
								<td style="width:100px;word-wrap:break-word;"><%= bd.mother_name%></td>
								<td style="width:100px;word-wrap:break-word;"><%= bd.husband_name%></td>
								<td style="width:80px;word-wrap:break-word;"><%= bd.time_of_birth%></td>
								<td style="width:80px;word-wrap:break-word;"><%= bd.birth_weight%></td>
								<td style="width:80px;word-wrap:break-word;"><%= bd.sex%></td>
