 ...
 * this code having delete(),deleteObject(),insertDeletedRecordById(),
 * insertDeletedRecordByUniqueId(),insertRemarks(),insertFeedBack(),insertComment(),insertCSVdetails(),
...
public class DeleteMongodbObject 
{
	 ...
	 * @return String contains success or failure message 
	 * @throws JSONException
	 */
	 ...
	 * @param id record id
	 * @param uid unique id
	 * @param delColl collection name from which the record has to be deleted
	 * @return the result of satisfied condition
	 */
	 ...
	 * @param period
	 * @param type - 
	 * @param ph - type String - phone number
	 * @param survey
	 * @return
	 */
	public int insertRemarks(String dbName,String collname,String name,String id,String role ,String callerName,String rem,String period,String type,String ph,String survey)
	{
     ...
     * @return integer value for update and insert
     */
	 ...
	 * @param db2 name of the database
	 * @param coll name of the collection
	 * @param reportType 
	 * @param size file size
	 * @return
	 */
	public int insertCSVdetails(String filename, String datefrom,String dateto,String db2,String coll,String reportType,String size)
	{
